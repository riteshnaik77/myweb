...
export default function Footer() {
    return (
        <footer className="py-20 text-center border-t border-white/5 w-full bg-[#0B0B0F]">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="flex justify-center gap-8 mb-8">
                    ...
                    >
                        ...
                        <span className="text-xs text-gray-600 group-hover:text-gray-400 transition-colors">Email</span>
                    </a>
                    ...
                    >
                        ...
                        <span className="text-xs text-gray-600 group-hover:text-gray-400 transition-colors">GitHub</span>
                    </a>
                    ...
                    >
                        ...
                        <span className="text-xs text-gray-600 group-hover:text-gray-400 transition-colors">LinkedIn</span>
                    </a>
                </div>

                {/* Copyright */}
                <p className="text-gray-600 text-sm">
                    © 2026 Ritesh. Built with Next.js & Framer Motion.
                </p>
            </div>
        </footer>
    );
