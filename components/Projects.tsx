...
const projects = [
    ...
    },
    {
        ...
        problem: "Manual HR policy lookup took 10–15 minutes per query across 50+ policy documents, slowing internal operations.",
        ...
        kpis: "Target lookup time under 1 min | Target 90% satisfaction score.",
        solution: "Built a RAG assistant with hybrid BM25 + vector search on Groq and Pinecone.",
        impact: "Lookup 10–15 min → seconds | 95% user satisfaction | 50+ policy documents indexed.",
        adoption: "Adopted as the default HR policy lookup across internal teams.",
    ...
    {
        title: "PLUTO — AI Resume Evaluator",
        problem: "High-volume resume evaluation took 5–10 mins per resume with inconsistent scoring across the team.",
        ...
        impact: "5–10 min → under 2 min per eval | Shortlist rate 50% → 70% (+40%) | Cost ₹4 → ₹0.57 (85% cut).",
        adoption: "Part of PLUTO — used by 150+ recruiters at ~85% daily active.",
    ...
    {
        title: "SpringBoard Analytics Platform",
        problem: "Monthly reporting meant manually stitching data from the ATS, job portals and call systems — slow, error-prone and always out of date.",
        persona: "Leadership, Operations & Recruiter Teams",
        hypothesis: "If ATS, job-portal and call data land in one real-time dashboard, manual reporting disappears and leaders act on live KPIs.",
        kpis: "Eliminate the majority of manual monthly reporting | Real-time KPI visibility.",
        solution: "Built an API-integrated analytics platform connecting the ATS (Oorwin/Ceipal), Naukri and VoxPro.",
        impact: "80% of manual monthly reporting eliminated | Real-time KPIs adopted organisation-wide.",
        adoption: "Adopted organisation-wide as the single source for recruitment KPIs.",
