...
- [x] Portfolio PDF (public/RiteshNaik_Resume.pdf) replaced with the current master resume
- [ ] Add IRIS as fifth case study (blocked on Ritesh providing problem / hard call / metric)
- [ ] RULE: whenever the master resume changes, re-export public/RiteshNaik_Resume.pdf
- [ ] After any edit: verify the Vercel deploy succeeded
